# FCOS3D config override for nuScenes full (v1.0-trainval, 150 val scenes).
#
...
# only what is needed for a clean inference run on the full val split.
...
val_evaluator = dict(data_root='data/nuscenes/')
test_evaluator = dict(data_root='data/nuscenes/')
